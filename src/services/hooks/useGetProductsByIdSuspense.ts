...
export const getProductsByIdSuspenseQueryKey = (
  id: GetProductsByIdPathParams["id"],
) => [{ url: "/products/:id", params: { id: id } }] as const;

export type GetProductsByIdSuspenseQueryKey = ReturnType<
  typeof getProductsByIdSuspenseQueryKey
>;
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getProductsByIdSuspenseQueryKey(id);

...
export const getProductsByIdQueryKey = (id: GetProductsByIdPathParams["id"]) =>
  [{ url: "/products/:id", params: { id: id } }] as const;

export type GetProductsByIdQueryKey = ReturnType<
  typeof getProductsByIdQueryKey
>;
...
export function getProductsByIdQueryOptions(
  id: GetProductsByIdPathParams["id"],
  headers: GetProductsByIdHeaderParams,
  config: Partial<RequestConfig> = {},
) {
...
>(
  ...
  }) as UseQueryResult<TData, ResponseErrorConfig<GetProductsById404>> & {
    queryKey: TQueryKey;
  };

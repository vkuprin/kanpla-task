...
export const getOrdersByIdSuspenseQueryKey = (id: GetOrdersByIdPathParams['id']) => [{ url: '/orders/:id', params: { id: id } }] as const

export type GetOrdersByIdSuspenseQueryKey = ReturnType<typeof getOrdersByIdSuspenseQueryKey>
...
export function getOrdersByIdSuspenseQueryOptions(id: GetOrdersByIdPathParams['id'], headers: GetOrdersByIdHeaderParams, config: Partial<RequestConfig> = {}) {
...
>(
  ...
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<ResponseConfig<GetOrdersByIdQueryResponse>, ResponseErrorConfig<GetOrdersById403 | GetOrdersById404>, TData, TQueryKey>
    >
  ...
  const query = useSuspenseQuery({
    ...(getOrdersByIdSuspenseQueryOptions(id, headers, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
    ...(queryOptions as unknown as Omit<UseSuspenseQueryOptions, 'queryKey'>),
  }) as UseSuspenseQueryResult<TData, ResponseErrorConfig<GetOrdersById403 | GetOrdersById404>> & { queryKey: TQueryKey }

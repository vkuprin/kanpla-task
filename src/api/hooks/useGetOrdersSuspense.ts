...
export type GetOrdersSuspenseQueryKey = ReturnType<typeof getOrdersSuspenseQueryKey>
...
export function getOrdersSuspenseQueryOptions(headers: GetOrdersHeaderParams, config: Partial<RequestConfig> = {}) {
...
>(
  ...
  options: {
    query?: Partial<UseSuspenseQueryOptions<ResponseConfig<GetOrdersQueryResponse>, ResponseErrorConfig<Error>, TData, TQueryKey>>
  ...
  const query = useSuspenseQuery({
    ...(getOrdersSuspenseQueryOptions(headers, config) as unknown as UseSuspenseQueryOptions),
    queryKey,
